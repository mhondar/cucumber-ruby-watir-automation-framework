@checkout
Feature: F1031 Pago Caja de Precio Continuar con mi compra

        Scenario: TC1124 Validar al Continuar con mi compra se muestre pagina de Confirmación
                Given Abro la pagina de ripley en ambiente "preprod" de "cl" "CHKOUT_F1031_TC1124"
