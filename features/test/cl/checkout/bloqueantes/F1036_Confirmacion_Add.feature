@checkout
Feature: F1036 Confirmacion Agregar Mas Productos

        Scenario: TC1145 Validar redireccione a la pagina del home
                Given Abro la pagina de ripley en ambiente "preprod" de "cl" "CHKOUT_F1036_TC1145"
                ...
                And Realizo click en Agregar mas productos en Confirmacion
