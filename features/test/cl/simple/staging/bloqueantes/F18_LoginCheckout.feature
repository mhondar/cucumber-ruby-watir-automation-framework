@simple
@simple_mobile
Feature: F18 Pantalla de Bienvenida a Ripley


    Scenario: TC-54 Validar en Pantalla de Bienvenida el login de Usuario Registrado
        Given Abro la pagina de ripley en ambiente "staging" de "cl" "SIMPLE_F18_TC-54"
